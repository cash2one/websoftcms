...
class Poster
{
    ...
    private function couplet($data,$info){
        ...
        //左面
        $str .= "theFloaters.addItem('followDiv1".$data['id']."',".$info['setting']['paddleft'].",".$info['setting']['paddtop'].",".$info['width'].",".$info['height'].",'left','".$str_left."');";
        //右面
        $str .= "theFloaters.addItem('followDiv2".$data['id']."',".$info['setting']['paddleft'].",".$info['setting']['paddtop'].",".$info['width'].",".$info['height'].",'right','".$str_right."');";
