...
class Broker extends MobileBase
{
    public function index()
    {
        ...
        $field = 'u.id,u.nick_name,u.mobile,d.company,d.service_area,d.tags,d.point,(FORMAT((d.point/5)*100,0)) as goods';
    ...
    public function detail()
    {
        ...
        if($id)
        {
            ...
            $field = 'id,city,title,estate_name,img,room,living_room,toilet,acreage,price,average_price,address,orientations,renovation,tags';
    ...
    public function second()
    {
        ...
        if($id)
        {
            ...
            $this->assign('lists',$lists);
            $this->assign('pages',$lists->render());
            $this->assign('title',$info['nick_name'].'二手房');
        }else{
            return $this->fetch('public/404');
        }
        return $this->fetch();
