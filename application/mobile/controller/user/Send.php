...
class Send extends UserBase
{
    ...
    public function initialize()
    {
        ...
        $setting = getUserCate();
        $this->setting = isset($setting[$this->userInfo['model']]['data'])?$setting[$this->userInfo['model']]['data']:[];//用户设置
    }
    /**
     * @return mixed
     * 添加二手房
    ...
    public function saveSecond()
    {
        ...
        $code   = 0;
        $msg    = '';
        $status = $this->setting?$this->setting['check_second']:1;
        if(request()->isAjax())
        {
    ...
    public function saveRental()
    {
        ...
        $code   = 0;
        $msg    = '';
        $status = $this->setting?$this->setting['check_rental']:1;
        if(request()->isAjax())
        {
