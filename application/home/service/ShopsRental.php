    ...
    public function lists($zoom,$city = 0)
    {
        ...
        if($lists)
        {
            foreach($lists as &$v)
            {
                ...
                $v['w_url']      = "/pages/shops_rental/detail/index?id=".$v['id'];
            ...
            if($estate)
            {
                ...
                foreach($estate as &$val)
                {
                    ...
                    $val['url'] = url('ShopsRental/index',['estate_id'=>$val['id']]);
                    $val['w_url'] = "/pages/shops_rental/index/index?estate_id=".$val['id'];
                }
            }
            $return['code']   = 1;
            $return['data']   = $lists;
