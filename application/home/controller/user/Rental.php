...
class Rental extends UserBase
{
    ...
    public function index()
    {
        ...
        $lists = model('rental')->where($where)->field($field)->order(['top_time'=>'desc','id'=>'desc'])->paginate(15,false,['query'=>$this->queryData]);
    ...
    public function edit()
    {
        ...
        if(!$id){
            ...
            $info = model('rental')->where($where)->find();
