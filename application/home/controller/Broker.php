...
class Broker extends HomeBase
{
    ...
    public function index()
    {
        ...
        $field = 'u.id,u.nick_name,u.mobile,d.service_area,d.company,d.tags,d.point,(FORMAT((d.point/5)*100,0)) as goods';
    ...
    public function second()
    {
        ...
        if($id)
        {
            ...
            $field = 'id,title,estate_name,img,room,living_room,toilet,acreage,price,average_price,address,orientations,renovation,tags';
            $lists = model('second_house')->where($where)->field($field)->order('create_time desc')->paginate(10);
