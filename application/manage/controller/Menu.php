...
class Menu extends ManageBase
{
    ...
    public function addDo(){
        //注册后置事件 只对模型调用
        \app\common\model\Menu::event('after_insert',function($obj){
            $obj->doCache();
           return true;
        });
        parent::addDo();
    ...
    public function editDo(){
        //注册后置事件 只对模型调用
        \app\common\model\Menu::event('after_update',function($obj){
            $obj->doCache();
            return true;
        });
        parent::editDo();
    ...
    public function delete(){
        //注册后置事件 只对模型调用
        \app\common\model\Menu::event('after_delete',function($obj){
            $obj->doCache();
            return true;
        });
        parent::delete();
    ...
    public function ajaxEdit()
    {
        ...
        cache('managemenu'.$this->adminInfo['role'],objToArray($lists));
