<?php /*a:3:{s:77:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/second/index.html";i:1544497558;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/layout.html";i:1536722262;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/footer.html";i:1535332940;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="header-top">
    <header id="header" class="h-list-head">
        ...
        <a href="<?php echo url('Map/second'); ?>" class="map-find-room">地图找房</a>
    </header>
    <!-- 筛选 S -->
    ...
    <!-- 筛选 E -->
    <ul id="search-lists" data-uri="<?php echo url('Ajax/searchSecond'); ?>"></ul>
</div>
...
<div class="main" style="background: #fff;padding-top:4.5rem;">
    ...
    <div class="old-house house-show-box">
        <ul id="lists" data-uri="<?php echo url('Second/getSecondLists'); ?>" data-total="<?php echo htmlentities($total_page); ?>">
            ...
            <li>
                <div class="pic">
                    <a href="<?php echo url('Second/detail',['id'=>$vo['id']]); ?>" title="<?php echo htmlentities($vo['title']); ?>">
                        ...
                        <?php if($storage_open == 1 and $vo['video']): ?><em class="video-play"></em><?php endif; ?>
                    </a>
                </div>
...
<script type="text/html" id="search-template">
    ...
    <li><a href="{{d[i].url}}"><span>{{d[i].price}}万</span><em>{{d[i].title}}</em></a></li>
    {{# } }}
</script>
<script type="text/html" id="template">
    ...
    <li>
        ...
        <div class="intro-text">
            ...
            <p>
                <span>{{d[i].room}}室{{d[i].living_room}}厅</span>
                <span>{{d[i].acreage}} {{d[i].renovation}}</span>
                <span>&nbsp; {{d[i].update_time}}更新</span>
            </p>
