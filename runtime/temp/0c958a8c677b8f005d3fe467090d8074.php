<?php /*a:4:{s:73:"/home/wwwroot/gxwebsoft/public_html/application/home/view/house/room.html";i:1539661850;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:72:"/home/wwwroot/gxwebsoft/public_html/application/home/view/house/nav.html";i:1544411302;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="con_wrap comWidth clearfix">
        <div class="houseType_wrap">
            <ul class="tab_nav clearfix">
                <li><a href="<?php echo url('House/room',['house_id'=>$info['id']]); ?>" <?php if($room == 0): ?>class="active"<?php endif; ?>>全部（<span id="total">0</span>）</a></li>
                ...
                <li><a href="<?php echo url('House/room',['house_id'=>$info['id'],'room'=>$vo['room']]); ?>" <?php if($room == $vo['room']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['room']); ?>室(<span class="room-cate"><?php echo htmlentities($vo['total']); ?></span>)</a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
                ...
                <li>
                    <div class="img">
                        <a href="<?php echo url('House/roomDetail',['id'=>$vo['id']]); ?>" title="<?php echo htmlentities($vo['title']); ?>">
                            ...
                            <p class="sale_state <?php echo htmlentities($sale_status[$vo['sale_status']]['alias']); ?>"><?php echo htmlentities($sale_status[$vo['sale_status']]['name']); ?></p>
                        </a>
                    </div>
                    <div class="con">
                        <p><?php echo htmlentities($vo['title']); ?> <?php echo htmlentities($vo['room']); ?>室<?php echo htmlentities($vo['living_room']); ?>厅<?php echo htmlentities($vo['kitchen']); ?>厨<?php echo htmlentities($vo['toilet']); ?>卫</p>
                        <p><span><?php echo htmlentities($vo['price']); ?>万</span>建筑面积<?php echo htmlentities($vo['acreage']); ?>㎡</p>
                    </div>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
