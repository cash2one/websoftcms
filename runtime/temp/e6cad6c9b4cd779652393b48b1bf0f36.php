<?php /*a:2:{s:74:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/nav/index.html";i:1539081750;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1536141234;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
            ...
            <table class="layui-table list-table" id="J_cate_tree" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('ajaxEdit'); ?>">
                ...
                <td>
                    <div class="layui-table-cell">
                        <?php echo $val['pos']==1 ? '页头菜单' : '<span style="color:green;">页脚菜单</span>'; ?>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
                        <?php if($val['open_type'] == '_self'): ?>当前页面<?php else: ?>新页面<?php endif; ?>
                    </div>
                </td>
                <td>
                    <?php echo htmlentities($val['seo_title']); ?>
                </td>
                <td>
                    <?php echo htmlentities($val['seo_keys']); ?>
                </td>
                <td>
                    <div class="layui-table-cell">
                        <span data-tdtype="edit" data-field="ordid" data-id="<?php echo htmlentities($val['id']); ?>" class="tdedit"><?php echo htmlentities($val['ordid']); ?></span>
                    </div>
                </td>
                ...
                <td align="center">
                    <?php echo rights($options,$val['id'],$val['title'],$menuid); if($val['is_sys'] == 0): ?>
                    <a href="javascript:void(0);" class="J_confirm layui-btn layui-btn-xs layui-btn-danger" data-uri="<?php echo url('delete',['id'=>$val['id']]); ?>" data-msg="确定删除该导航么？">删除</a>
                    <?php endif; ?>
                </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
