<?php /*a:3:{s:79:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/broker/comment.html";i:1523107014;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/layout.html";i:1536722262;s:83:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/broker/broker_info.html";i:1541130154;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="agent-survey mb20">
    ...
    <ul class="star-level clearfix">
        <?php $__FOR_START_1490790594__=1;$__FOR_END_1490790594__=6;for($i=$__FOR_START_1490790594__;$i < $__FOR_END_1490790594__;$i+=1){ ?>
    ...
    <div class="comment-list user-comment">
        ...
        <ul class="item">
            ...
            <li class="clearfix">
                <div class="pic fl"><img src="<?php echo getAvatar($vo['user_id'],90); ?>" alt="<?php echo htmlentities($vo['user_name']); ?>"></div>
                <div class="comment-content fl">
                    <div class="username-level clearfix">
                        <div class="username fl"><?php echo htmlentities($vo['user_name']); ?></div>
                        <div class="level level-<?php echo htmlentities($vo['point']); ?> fr"></div><!-- 等级从0到5 -->
                    </div>
                    <div class="desc_box">
                        <p><?php echo htmlentities($vo['content']); ?></p>
                    </div>
                    <div class="babel-list clearfix">
                        <?php $c_tags=array_filter(explode(',',$vo['tags'])); if(is_array($c_tags) || $c_tags instanceof \think\Collection || $c_tags instanceof \think\Paginator): $i = 0; $__LIST__ = $c_tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
                        <em><?php echo getLinkMenuName(13,$t); ?></em>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                    <time class="time"><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($vo['create_time'])? strtotime($vo['create_time']) : $vo['create_time'])); ?></time>
                </div>
            </li>
