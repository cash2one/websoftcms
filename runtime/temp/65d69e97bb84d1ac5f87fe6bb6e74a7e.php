<?php /*a:3:{s:83:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/shops_rental/index.html";i:1541067758;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/layout.html";i:1536722262;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/footer.html";i:1535332940;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="header-top">
    <header id="header" class="h-list-head">
        ...
        <a href="<?php echo url('Map/shopsRental'); ?>" class="map-find-room">地图找房</a>
    </header>
    <!-- 筛选 S -->
    <div class="lr-select-box">
        ...
        <div class="select_body" id="select_body">
            ...
            <div class="item common">
                <div class="item_box">
                    <ul>
                        <li><a href="<?php echo url('Shops/index'); ?>" title="商铺出售">商铺出售</a></li>
                        <li><a href="<?php echo url('ShopsRental/index'); ?>" title="商铺出租">商铺出租</a></li>
                    </ul>
                </div>
            </div>
            <div class="item common">
    ...
    <!-- 筛选 E -->
    <ul id="search-lists" data-uri="<?php echo url('Ajax/searchShopsRental'); ?>"></ul>
</div>
...
<div class="main" style="background: #fff;padding-top:4.5rem;">
    ...
    <div class="old-house house-show-box">
        <ul id="lists" data-uri="<?php echo url('ShopsRental/getShopsRentalLists'); ?>" data-total="<?php echo htmlentities($total_page); ?>">
            ...
            <li>
                <div class="pic">
                    <a href="<?php echo url('ShopsRental/detail',['id'=>$vo['id']]); ?>" title="<?php echo htmlentities($vo['title']); ?>">
                ...
                <div class="intro-text">
                    ...
                    <p class="detail-text"><?php echo htmlentities($vo['acreage']); ?><?php echo config('filter.acreage_unit'); ?> <?php echo getLinkMenuName(18,$vo['type']); ?> <?php echo getLinkMenuName(8,$vo['renovation']); ?>&nbsp; <?php echo getTime($vo['update_time'],'mohu'); ?>更新</p>
                    <p class="good">
                        ...
                        <em><?php echo getLinkMenuName(20,$val); ?></em>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <?php endif; ?>
                    </p>
                </div>
