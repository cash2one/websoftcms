<?php /*a:2:{s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/comment/house.html";i:1544413698;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <tr>
                    <td>
                        <div class="layui-table-cell">
                            <a href="<?php echo url('House/detail',['id'=>$val['house_id']]); ?>" target="_blank"><?php echo htmlentities($val['title']); ?></a>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <?php if($val['status'] == 0): ?><span  style="color:#ff0000;">待审</span><?php else: ?>已审<?php endif; ?>
                        </div>
                    </td>
                </tr>
