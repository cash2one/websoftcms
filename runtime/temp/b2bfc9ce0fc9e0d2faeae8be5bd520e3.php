<?php /*a:4:{s:73:"/home/wwwroot/gxwebsoft/public_html/application/home/view/house/news.html";i:1532422476;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:72:"/home/wwwroot/gxwebsoft/public_html/application/home/view/house/nav.html";i:1544411302;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="con_wrap comWidth clearfix">
        <div class="leftArea cm_leftArea">
            ...
            <ul class="dynamic_list">
                ...
                <li>
                    ...
                    <div class="r_con">
                        <h3><?php echo htmlentities($data['title']); ?></h3>
                        <p><?php echo htmlentities($data['description']); ?><a href="<?php echo url('News/detail',['id'=>$data['id']]); ?>">[查看详情]</a></p>
                    </div>
                </li>
        ...
        <div class="rightArea cm_rightArea ">
            ...
            <div class="hot_artc mt_30">
                ...
                <div class="con_box">
                    <ul class="clearfix">
                        <?php $obj = model("article");$obj = $obj->where("status=1");$obj = $obj->field("id,title");$obj = $obj->order("hits desc");$name = $obj->limit(10)->select();if(is_array( $name ) || $name  instanceof \think\Collection || $name instanceof \think\Paginator ): $i = 0; $__LIST__ = $name;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                        <li>
                            <a href="<?php echo url('News/detail',['id'=>$data['id']]); ?>" title="<?php echo htmlentities($data['title']); ?>">
