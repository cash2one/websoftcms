<?php /*a:2:{s:83:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/agent_company/edit.html";i:1541076700;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1536141234;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="cate_id" id="cate_id">
                            ...
                            <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $info['cate_id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['title']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="company_name" lay-verify="required" value="<?php echo htmlentities($info['company_name']); ?>" class="layui-input" placeholder="俱进科技">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span class="layui-form-alert">*</span>联系人</label>
                    <div class="layui-input-inline">
                        <input type="text" name="contact_name" lay-verify="required" value="<?php echo htmlentities($info['contact_name']); ?>" id="contact_name" placeholder="联系人" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" lay-verify="required|phone" value="<?php echo htmlentities($info['mobile']); ?>" id="mobile" name="mobile" placeholder="手机号码">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span class="layui-form-alert">*</span>代理城市</label>
                    <div class="layui-input-inline">
                        <?php $area_arr = array_filter(explode(',',$info['city'])); ?>
                            <span id="service_box">
                        ...
                        <input type="hidden" class="layui-input" name="city" lay-verify="required" value="<?php echo htmlentities($info['city']); ?>," id="service_area" placeholder="">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" id="service_time_end" value="<?php echo htmlentities(date('Y-m-d',!is_numeric($info['service_time_end'])? strtotime($info['service_time_end']) : $info['service_time_end'])); ?>" name="service_time_end" placeholder="2018-12-12">
                    </div>
                </div>
                <div class="layui-form-item">
