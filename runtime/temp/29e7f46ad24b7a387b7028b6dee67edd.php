...
<div class="main">
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <video src="<?php echo getVideoUrl($info['video']); ?>" style="width:100%;height:10rem;" controls="controls" poster="<?php echo htmlentities($info['img']); ?>"></video>
                </div>
    ...
    <div class="house-detail-intro">
        ...
        <ul class="price-house-area">
            <li>
                <p>售价</p>
                <em><?php echo $info['price']; ?></em>
            </li>
            <li>
                <p>户型</p>
                <em><?php echo htmlentities($info['room']); ?>室<?php echo htmlentities($info['living_room']); ?>厅<?php echo htmlentities($info['toilet']); ?>卫</em>
            </li>
            <li>
                <p>面积</p>
                <em><?php echo htmlentities($info['acreage']); ?><?php echo config('filter.acreage_unit'); ?></em>
            </li>
        </ul>
        <ul class="intro-small-detail">
            <li class="top-three"><span>单价：<em class="price"><?php echo $info['average_price']; ?></em></span><span>装修：<em><?php echo getLinkMenuName(8,$info['renovation']); ?></em></span></li>
            <li class="top-three"><span>楼层：<em class="floor"><?php echo getLinkMenuName(7,$info['floor']); ?>/<?php echo htmlentities($info['total_floor']); ?></em></span><span>朝向：<em><?php echo getLinkMenuName(4,$info['orientations']); ?></em></span></li>
            <li class="top-three"><span>类型：<em><?php echo getLinkMenuName(9,$info['house_type']); ?></em></span><span>年代：<em class="year"><?php echo htmlentities($estate['years']); ?></em></span></li>
            <li class="after-three">
                <span>更新：</span>
                <em><?php echo getTime($info['update_time'],'mohu'); ?></em>
            </li>
            <li class="after-three"><a href="<?php echo url('Estate/detail',['id'=>$estate['id']]); ?>" title="<?php echo htmlentities($estate['title']); ?>"><span>小区：<em><?php echo htmlentities($estate['title']); ?></em></span></a></li>
...
<script>
    ...
    <div class="guess-love-room">
        ...
        <a href="<?php echo url('Second/index'); ?>" class="more-house-btn">更多房源</a>
    </div>
    <!-- 猜你喜欢 E-->
    <!-- 白块  S-->
    ...
    <!-- 导航行为 S-->
    <div class="nav-act">
        <a href="javascript:;" class="follow" data-id="<?php echo htmlentities($info['id']); ?>" data-model="second_house" data-uri="<?php echo url('Api/follow'); ?>">关注</a>
        ...
        <a href="javascript:;" class="order-l-house dialog" data-id="<?php echo htmlentities($info['id']); ?>" data-model="second_house" data-type="1" data-uri="<?php echo url('Dialog/subscribe'); ?>">预约看房</a>
    </div>
    <!-- 导航行为 E-->
