<?php /*a:3:{s:76:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/shops/index.html";i:1541067758;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/layout.html";i:1536722262;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/footer.html";i:1535332940;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="header-top">
    <header id="header" class="h-list-head">
        ...
        <a href="<?php echo url('Map/shops'); ?>" class="map-find-room">地图找房</a>
    </header>
    <!-- 筛选 S -->
    ...
    <!-- 筛选 E -->
    <ul id="search-lists" data-uri="<?php echo url('Ajax/searchShops'); ?>"></ul>
</div>
...
<div class="main" style="background: #fff;padding-top:4.5rem;">
    ...
    <div class="old-house house-show-box">
        <ul id="lists" data-uri="<?php echo url('Shops/getShopsLists'); ?>" data-total="<?php echo htmlentities($total_page); ?>">
            ...
            <li>
                <div class="pic">
                    <a href="<?php echo url('Shops/detail',['id'=>$vo['id']]); ?>" title="<?php echo htmlentities($vo['title']); ?>">
