<?php /*a:3:{s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/follow/estate.html";i:1541044804;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;s:78:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/follow/nav.html";i:1541044554;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form layui-border-box layui-table-view">
            <table id="tree-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <th>
                        <div class="layui-table-cell"><span>房源数</span></div>
                    </th>
                    <th>
                ...
                <tr>
                    <td>
                        <div class="layui-table-cell">
                            <a href="<?php echo url('Rental/detail',['id'=>$val['id']]); ?>" target="_blank"><?php echo htmlentities($val['title']); ?></a>
                        </div>
                    </td>
                    <td>
                        <div class="layui-table-cell">
                            在售二手房（<a href="<?php echo url('Second/index',['estate_id'=>$val['id']]); ?>" target="_blank"><b><?php echo htmlentities($val['second_total']); ?></b></a>）套
                            在租房源（<a href="<?php echo url('Rental/index',['estate_id'=>$val['id']]); ?>" target="_blank"><b><?php echo htmlentities($val['rental_total']); ?></b></a>）套
                        </div>
                    </td>

                    <td>
                        <div class="layui-table-cell">
                            <?php echo htmlentities($val['price']); ?><?php echo config('filter.price_unit'); ?>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <a href="javascript:;" data-id="<?php echo htmlentities($val['id']); ?>" data-model="estate" data-uri="<?php echo url('Api/userCancelFollow'); ?>" class="cancel-follow layui-btn layui-btn-xs layui-btn-danger">取消关注</a>
                        </div>
                    </td>
                </tr>
