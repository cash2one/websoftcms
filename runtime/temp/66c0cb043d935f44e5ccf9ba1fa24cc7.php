<?php /*a:2:{s:78:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/office/add.html";i:1540979730;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="content add_house">
    <form class="layui-form" id="info_form" action="<?php echo url('user.office/save'); ?>" method="post" enctype="multipart/form-data">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li style="float:right;"><a href="<?php echo url('user.office/index'); ?>" class="layui-btn layui-btn-sm" style="color:#fff;">写字楼列表</a></li>
                <li class="layui-this">发布出售</li>
                <li><a href="<?php echo url('user.office_rental/add'); ?>">发布出租</a></li>
            </ul>
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="contact_phone" lay-verify="phone" id="contact_phone" value="<?php echo htmlentities($userInfo['mobile']); ?>" placeholder="联系电话" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-block">
                            ...
                            <div class="layui-input-block">
                                <?php echo getLinkMenu(17,'grade','radio'); ?>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-block">
                            ...
                            <div class="layui-input-block">
                                <?php echo getLinkMenu(15,'type','radio'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-block">
                            ...
                            <div class="layui-input-block">
                                <?php echo getLinkMenu(16,'tags','checkbox'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
