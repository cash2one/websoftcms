<?php /*a:2:{s:76:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/metro/index.html";i:1541125576;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<div class="layui-form" >
    <form name="layui-form" class="search-form" action="<?php echo url('Metro/index'); ?>" method="get" >
            ...
            <div class="layui-table-header">
                <table class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('ajaxEdit'); ?>">
                    ...
                    <tr data-index="<?php echo htmlentities($i); ?>" class="">
                        ...
                        <td>
                            <div class="layui-table-cell">
                                <?php echo getCityName($val['city']); ?>-<?php echo htmlentities($val['name']); ?>
                            </div>
                        </td>
                        <td>
                            <div class="layui-table-cell">
