<?php /*a:2:{s:81:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/pages_cate/index.html";i:1517994948;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<form class="layui-form" action="">
    <div class="layui-form layui-border-box layui-table-view">
        <div class="layui-table-header">
            <table class="layui-table list-table" id="J_cate_tree" cellspacing="0" cellpadding="0" border="0" style="width:100%;" data-uri="<?php echo url('pages/PagesCate/ajaxEdit'); ?>">
                <colgroup>
                    <col width="5%">
                    <col width="25%">
                    <col width="25%">
                ...
                <td>
                    <div class="layui-table-cell">
                        <?php echo htmlentities($val['alias']); ?>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
