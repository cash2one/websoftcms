<?php /*a:4:{s:83:"/home/wwwroot/gxwebsoft/public_html/application/home/view/office_rental/detail.html";i:1540892286;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/peitao.html";i:1544237904;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page_tit">
    <div class="comWidth clearfix">
        ...
        <a href="<?php echo url('OfficeRental/index'); ?>">写字楼出租</a> &gt;
    ...
    <div class="comWidth">
        ...
        <div class="main_info">
            <div class="hd_box clearfix">
                ...
                <!-- on表示已收藏 -->
                <span class="collect_btn follow fr" data-id="<?php echo htmlentities($info['id']); ?>" data-model="office_rental" data-uri="<?php echo url('Api/follow'); ?>">关注房源</span>
            </div>
            <div class="con_box clearfix">
                ...
                <div class="rightArea">
                    <div class="t_box clearfix">
                        <div class="price fl">
                            <span><strong><?php echo $info['price']; ?></strong></span><span style="margin-left:10px;"><?php echo htmlentities($info['average_price']); ?></span>
                        </div>
                    </div>
                    ...
                    <ul class="col_3_list clearfix">
                        ...
                        <li>
                            <p class="tit"><?php echo getLinkMenuName(17,$info['grade']); ?></p>
                            <p class="txt">等级</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p class="tit"><?php echo getLinkMenuName(15,$info['type']); ?></p>
                            <p class="txt">类型</p>
                        </li>
                    </ul>
                    <div class="col_1 clearfix">
                        <span class="label">物业费 : </span><span class="desc"><?php echo htmlentities($info['property_fee']); ?></span>
                    </div>
                    <div class="col_1 clearfix">
                    ...
                    <div class="agent_info clearfix" style="margin-top:30px;">
                        ...
                        <div class="c_con fl">
                            <div class="row clearfix">
                                ...
                                <p class="name fl"><a href="<?php echo url('Broker/officeRental',['id'=>$info['broker_id']]); ?>" title="<?php echo htmlentities($info['contact_name']); ?>写字楼" target="_blank"><?php echo htmlentities($info['contact_name']); ?>(经纪人)</a></p>
                                <?php else: ?>
                        ...
                        <div class="r_con fr">
                            <a href="javascript:void(0);" class="btn appoint J_dialog" data-id="<?php echo htmlentities($info['id']); ?>" data-model="office_rental" data-type="1" data-uri="<?php echo url('Dialog/subscribe'); ?>">预约看房</a>
                        </div>
                    </div>
            ...
            <div class="similar_house floor">
                ...
                <div class="con_box">
                    <ul class="list clearfix">
                        ...
                        <li>
                            <a href="<?php echo url('OfficeRental/detail',['id'=>$data['id']]); ?>" title="<?php echo htmlentities($data['title']); ?>">
                                <div class="img">
