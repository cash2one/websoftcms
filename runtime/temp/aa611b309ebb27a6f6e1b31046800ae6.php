<?php /*a:2:{s:80:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/office/index.html";i:1541042172;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab">
    ...
    <a href="<?php echo url('user.office_rental/index'); ?>" style="margin-left:20px;">写字楼出租</a>
</div>
<div class="layui-form">
    <form name="layui-form" class="search-form" action="<?php echo url('user.office/index'); ?>" method="get" >
...
<form class="layui-form" action="">
    <div class="layui-form layui-border-box layui-table-view">
        <table id="list-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-model="office" data-uri="<?php echo url('Api/setTop'); ?>">
            <colgroup>
                <col width="5%">
                <col width="10%">
                <col width="40%">
            ...
            <tr>
                ...
                <td class="layui-center">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo url('edit',['id'=>$val['id']]); ?>" class="layui-btn layui-btn-xs">编辑</a><a href="javascript:;" data-msg="您确认要删除该条房源么？" data-uri="<?php echo url('user.office/delete',['id'=>$val['id']]); ?>" class="J_confirm layui-btn layui-btn-xs layui-btn-danger">删除</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
    ...
    <div class="kaifazhe-fix-bottom layui-clear">
        <div class="kaifazhe-list-option layui-fl">
            ...
            <button type="button" lay-submit lay-filter="optionAll" data-msg="确定要删除所选项目么？" data-uri="<?php echo url('user.office/delete'); ?>" class="layui-btn layui-btn-danger layui-btn-sm">删除</button>
        </div>
