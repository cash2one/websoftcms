<?php /*a:3:{s:72:"/home/wwwroot/gxwebsoft/public_html/application/home/view/map/index.html";i:1540867520;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="comWidth clearfix">
            ...
            <div class="sele_list fl">
                <form action="">
                    ...
                    <div class="item  fl">
                        <button type="button" class="btn search-btn" data-uri="<?php echo url('Map/getHouseLists'); ?>">搜索</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="house_list">
                <div class="hd clearfix">
                    <ul class="fl tab sort">
                        ...
                        <li>
                            <a href="javascript:;" data-sort="3" class="time down">开盘</a>
                        </li>
                    </ul>
                    <span class="b_l"></span>
                </div>
        ...
        <a href="{{d[i].url}}" target="_blank" title="{{d[i].title}}">
            ...
            <div class="c_con fl">
                <div class="t clearfix">
                    <h3>{{d[i].title}}</h3>
                    <span class="sale_type">{{d[i].sale_status_name}}</span>
                </div>
                <div class="c">
                    <span>{{d[i].min_type}}{{# if(d[i].max_type){ }}-{{d[i].max_type}}{{# } }}室</span>
                    <span>{{d[i].min_acreage}}{{# if(d[i].max_acreage){ }}-{{d[i].max_acreage}}{{# } }}㎡</span>
                </div>
            ...
            <div class="r_con fl">
                <p class="price"><strong>{{d[i].price}}</strong>{{d[i].unit}}</p>
            </div>
        </a>
    </li>
    {{# } }}
...
<script type="text/javascript">
    ...
    function getParam()
    {
        var city = $('#city').val(),price = $('#price').val(),type = $('#type').val(),tags = $('#special').val(),
                status = $('#status').val();
