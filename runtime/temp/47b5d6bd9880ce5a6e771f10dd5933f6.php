<?php /*a:2:{s:77:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/answer/index.html";i:1532752006;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
    ...
    <div class="layui-form layui-border-box layui-table-view">
        <table id="tree-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('ajaxEdit'); ?>">
            ...
            <tr>
                ...
                <th>
                    <div class="layui-table-cell"><span>回复人</span></div>
                </th>
                <th>
                    <div class="layui-table-cell"><span>电话</span></div>
                </th>
                <th>
                    <div class="layui-table-cell"><span>回复内容</span></div>
                </th>
                <th>
                    <div class="layui-table-cell"><span>问题</span></div>
                </th>
                <th>
                    <div class="layui-table-cell"><span>回复时间</span></div>
                </th>
                <th>
            ...
            <tr>
                ...
                <td data-field="title" date-edit="true">
                    <div class="layui-table-cell">
                        <?php echo htmlentities($val['broker_name']); ?>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
                ...
                <td>
                    <?php echo htmlentities($val['questioin_con']); ?>
                </td>
                <td>
                    <div class="layui-table-cell">
                ...
                <td>
                    <div class="layui-table-cell">
                        <?php echo rights($options,$val['id'],$val['broker_name'],$menuid); ?>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
