<?php /*a:3:{s:78:"/home/wwwroot/gxwebsoft/public_html/application/home/view/recommend/index.html";i:1544407176;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="cm_house">
    <div class="comWidth">
        <!-- 页面标识 S-->
        <div class="page_tit">
            <a href="javascript:;" rel="nofollow">您的位置：</a> <a href="<?php echo url('Index/index'); ?>" title="<?php echo htmlentities($site['title']); ?>">首页</a> &gt; <a href="javascript:void(0);">推荐楼盘</a>
        </div>
        <!-- 页面标识 E-->
        <!-- 筛选栏 S -->
        <div class="seleBar">
            ...
            <div class="search-tab clearfix">
                <a href="<?php echo getUrl('Recommend/index','search_type',[],1); ?>" title="按区域查询" <?php if($search['search_type'] == 1): ?>class="active"<?php endif; ?>><i class="iconfont">&#xe609;</i>按区域查询</a>
                <a href="<?php echo getUrl('Recommend/index','search_type',[],2); ?>" title="按地铁查询" <?php if($search['search_type'] == 2): ?>class="active"<?php endif; ?>><i class="iconfont">&#xe61e;</i>按地铁查询</a>
            </div>
            <?php endif; ?>
            <div class="box">
                <div class="item clearfix">
                    <h3>区域:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('Recommend/index','area',$param,0); ?>" <?php if($search['area'] == $cityId): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('Recommend/index','area',$param,$vo['id']); ?>" <?php if($search['area'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                ...
                <div class="item clearfix">
                    <h3>商圈:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('Recommend/index','area',$param,$param['area']); ?>" <?php if($search['rading'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('Recommend/index','area',$param,$vo['id']); ?>" <?php if($search['rading'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <?php endif; ?>
                <div class="item clearfix">
                    <h3>均价:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('Recommend/index','price',$param,0); ?>" <?php if($search['price'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('Recommend/index','price',$param,$key); ?>" <?php if($search['price'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>特色:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('Recommend/index','special',$param,0); ?>" <?php if($search['special'] == 0): ?>class="active"<?php endif; ?>>全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('Recommend/index','special',$param,$vo['id']); ?>" <?php if($search['special'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                        ...
                        <ul class="list" id="select">
                            <li>
                                <select name="type" id="type">
                                    <option value="0" data-uri="<?php echo getUrl('Recommend/index','type',$param,0); ?>">楼盘类型</option>
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" data-uri="<?php echo getUrl('Recommend/index','type',$param,$vo['id']); ?>" <?php if($search['type'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </li>
                            <li>
                                <select name="status" id="status">
                                    <option value="0" data-uri="<?php echo getUrl('Recommend/index','status',$param,0); ?>">销售状态</option>
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" data-uri="<?php echo getUrl('Recommend/index','status',$param,$vo['id']); ?>" <?php if($search['status'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </li>
                            <li>
                                <select name="renovation" id="renovation">
                                    <option value="0" data-uri="<?php echo getUrl('Recommend/index','renovation',$param,0); ?>">装修程度</option>
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" data-uri="<?php echo getUrl('Recommend/index','renovation',$param,$vo['id']); ?>" <?php if($search['renovation'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </li>
        ...
        <div class="main clearfix">
            ...
            <div class="houseList_wrap leftArea cm_leftArea newhouse">
                <div class="head clearfix">
                    <div class="tit fl">
                        <h2><a href="<?php echo url('House/index'); ?>">全部楼盘</a></h2>
                        <h2><a href="<?php echo url('House/index'); ?>?discount=1">优惠楼盘</a></h2>
                        <h2><a href="<?php echo url('Recommend/index'); ?>" class="active">推荐楼盘</a></h2>
                    </div>
                    <div class="tab fr">
                        <ul>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,0); ?>" style="background:none;" <?php if($search['sort'] == 0): ?>class="active"<?php endif; ?>>默认排序</a></li>
                            <?php if($search['sort'] == 1): ?>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,2); ?>" class="active up">价格</a></li>
                            <?php elseif($search['sort'] == 2): ?>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,1); ?>" class="active down">价格</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,1); ?>">价格</a></li>
                            <?php endif; if($search['sort'] == 3): ?>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,4); ?>" class="active down">开盘时间</a></li>
                            <?php elseif($search['sort'] == 4): ?>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,3); ?>" class="active up">开盘时间</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('Recommend/index','sort',$param,3); ?>">开盘时间</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                        ...
                        <li>
								<span class="l_img fl">
									...
									<img src="/static/home/images/nopic.jpg" data-original="<?php echo thumb($vo['img'],220,160); ?>" class="lazy" alt="<?php echo htmlentities($vo['title']); ?>">
                                        <?php if(getSettingCache('site','red_packet') == 1 and $vo['red_packet'] > 0): ?><em class="red-packet"></em><?php endif; ?>
                                    </a>
                                </span>
								<span class="r_con fr">
									<h3>
									...
									<span class="price">
										<h5><?php if(empty($vo['price']) || (($vo['price'] instanceof \think\Collection || $vo['price'] instanceof \think\Paginator ) && $vo['price']->isEmpty())): ?><strong>待定</strong><?php else: ?><strong><?php echo htmlentities($vo['price']); ?></strong><?php echo getUnitData($vo['unit']); ?><?php endif; ?></h5>
									</span>
								</span>
                            </a>
                        </li>
                            ...
                            <li class="clearfix">
                                <a href="<?php echo url('House/detail',['id'=>$vo['id']]); ?>" target="_blank" title="<?php echo htmlentities($vo['title']); ?>">
                                    ...
                                    <div class="fr r_con">
                                        ...
                                        <p class="address"><?php echo getCityName($vo['city'],'',2); ?></p>
