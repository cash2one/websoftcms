<?php /*a:2:{s:82:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/article/roll_back.html";i:1532751846;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<form class="layui-form" action="">
    <div class="layui-form layui-border-box layui-table-view">
        <div class="layui-table-header">
            <table id="tree-table" class="layui-table list-table" lay-filter="tree-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('Article/ajaxEdit'); ?>">
                <colgroup>
                    <col width="5%">
                    <col width="5%">
                    <col width="25%">
                ...
                <tr data-index="<?php echo htmlentities($i); ?>" class="">
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($val['delete_time'])? strtotime($val['delete_time']) : $val['delete_time'])); ?>
                        </div>
                    </td>
                    <td>
                        <div class="layui-table-cell">
    ...
    <div class="kaifazhe-fix-bottom layui-clear">
        <div class="kaifazhe-list-option layui-fl">
            ...
            <button type="button" lay-submit lay-filter="optionAll" data-uri="<?php echo url('Article/recovery'); ?>" data-msg="确定要恢复所选项目么？" class="layui-btn layui-btn-sm">恢复</button>
            <button type="button" lay-submit lay-filter="optionAll" data-uri="<?php echo url('Article/delTure'); ?>" data-msg="确定要删除所选项目么？" class="layui-btn layui-btn-danger layui-btn-sm">删除</button>
        </div>
