<?php /*a:2:{s:75:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/link/index.html";i:1541125488;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<div class="layui-form" >
    <form name="layui-form" class="search-form" action="<?php echo url('Link/index'); ?>" method="get" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <select name="cate_id">
                    ...
                    <?php if(is_array($cate_list) || $cate_list instanceof \think\Collection || $cate_list instanceof \think\Paginator): $i = 0; $__LIST__ = $cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo htmlentities($val['id']); ?>" <?php if($search['cate_id'] == $val['id']): ?> selected="selected" <?php endif; ?>><?php echo htmlentities($val['name']); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                    </div>
            </div>
    ...
    <form class="layui-form" action="">
        <div class="layui-form layui-border-box layui-table-view">
            <div class="layui-table-header">
                <table class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('Link/ajaxEdit'); ?>">
                    <colgroup>
                        <col width="5%">
                        <col width="5%">
                        <col width="20%">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="layui-table-cell">
                                <span data-tdtype="edit" data-field="name" data-id="<?php echo htmlentities($val['id']); ?>" class="tdedit">
                                ...
                                <a href="<?php echo htmlentities($val['img']); ?>" class="thumb" target="_blank" data-thumb="<?php echo htmlentities($val['img']); ?>"><i class="layui-icon">&#xe64a;</i></a>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="layui-table-cell">
                                <?php echo htmlentities($val['url']); ?>
                            </div>
                        </td>
                        <td>
                            <div class="layui-table-cell">
                                <?php echo htmlentities($val['linkcate']['name']); ?>
                            </div>
                        </td>
                        <td>
                            <div class="layui-table-cell">
                                <?php echo htmlentities($val['ordid']); ?>
                            </div>
                        </td>
        ...
        <div class="kaifazhe-fix-bottom layui-clear">
            <div class="kaifazhe-list-option layui-fl">
                ...
                <button type="button" lay-submit lay-filter="optionAll" data-msg="确定要删除所选项目么？" data-uri="<?php echo url('Link/delete'); ?>" class="layui-btn layui-btn-danger layui-btn-sm">删除</button>
            </div>
