    ...
    <div class="con_wrap comWidth clearfix">
        <div class="picture_wrap">
            <ul class="tab_nav clearfix">
                <li><a href="<?php echo url('House/photo',['house_id'=>$info['id']]); ?>" <?php if($cate_id == 0): ?>class="active"<?php endif; ?>>全部（<?php echo htmlentities($cate['total']); ?>）</a></li>
                ...
                <li><a href="<?php echo url('House/photo',['house_id'=>$info['id'],'cate_id'=>$vo['cate_id']]); ?>" title="<?php echo htmlentities($vo['name']); ?>" <?php if($cate_id == $vo['cate_id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?>(<?php echo htmlentities($vo['total']); ?>)</a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <ul class="list_box clearfix" id="photo">
                <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li>
                    <a href="<?php echo htmlentities($vo['url']); ?>" title="<?php echo htmlentities($vo['cate_name']); ?>-<?php echo htmlentities($vo['title']); ?>" rel="prettyPhoto[]">
                        <img src="/static/images/nopic.jpg" data-original="<?php echo thumb($vo['url'],285,205); ?>" class="lazy">
                        <div class="mask">
