<?php /*a:3:{s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/shops_rental/index.html";i:1544177964;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="searBar ">
    <div class="comWidth clearfix">
        <div class="sear_box fl">
            <form action="<?php echo url('ShopsRental/index'); ?>">
                <div class="ipt_area fl">
                    <input type="text" name="keyword" id="keyword" autocomplete="off" placeholder="输入小区名称或房源名称" data-uri="<?php echo url('Ajax/searchShopsRental'); ?>" class="ipt">
        ...
        <a href="<?php echo url('Map/shopsRental'); ?>" class="map_btn fr">地图找房</a>
    </div>
</div>
<!-- 搜索栏 E -->
<!-- 楼盘列表 S-->
<div class="cm_house">
    <div class="comWidth">
        ...
        <div class="page_tit">
            ...
            <a href="javascript:void(0);">商铺出租</a>
        </div>
        <!-- 页面标识 E-->
        <!-- 筛选栏 S -->
        ...
        <div class="seleBar">
            ...
            <div class="search-tab clearfix">
                <a href="<?php echo getUrl('ShopsRental/index','search_type',[],1); ?>" title="按区域查询" <?php if($search['search_type'] == 1): ?>class="active"<?php endif; ?>><i class="iconfont">&#xe609;</i>按区域查询</a>
                <a href="<?php echo getUrl('ShopsRental/index','search_type',[],2); ?>" title="按地铁查询" <?php if($search['search_type'] == 2): ?>class="active"<?php endif; ?>><i class="iconfont">&#xe61e;</i>按地铁查询</a>
            </div>
            <?php endif; ?>
            <div class="box">
                <div class="item clearfix">
                    <h3>区域:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','area',$param,0); ?>" <?php if($search['area'] == $cityId): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('ShopsRental/index','area',$param,$vo['id']); ?>" <?php if($search['area'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                ...
                <div class="item clearfix">
                    <h3>商圈:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','area',$param,$param['area']); ?>" <?php if($search['rading'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('ShopsRental/index','area',$param,$vo['id']); ?>" <?php if($search['rading'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <?php endif; ?>
                ...
                <div class="item clearfix">
                    <h3>租金:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','price',$param,0); ?>" <?php if($search['price'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        <?php $_result=getBussinessCondition('shops_rental_price');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo getUrl('ShopsRental/index','price',$param,$key); ?>" <?php if($search['price'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>面积:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','acreage',$param,0); ?>" <?php if($search['acreage'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        <?php $_result=getBussinessCondition("shops_acreage");if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo getUrl('ShopsRental/index','acreage',$param,$key); ?>" <?php if($search['acreage'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>类型:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','type',$param,0); ?>" <?php if($search['type'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('ShopsRental/index','type',$param,$vo['id']); ?>" <?php if($search['type'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>类别:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','lease_type',$param,0); ?>" <?php if($search['lease_type'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        <?php $_result=getLeaseType();if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo getUrl('ShopsRental/index','lease_type',$param,$key); ?>" <?php if($search['lease_type'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>特色:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('ShopsRental/index','tags',$param,0); ?>" <?php if($search['tags'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('ShopsRental/index','tags',$param,$key); ?>" <?php if($search['tags'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="main clearfix">
            ...
            <div class="houseList_wrap leftArea cm_leftArea">
                <div class="head clearfix">
                    <div class="tit fl">
                        <h2><a href="<?php echo url('ShopsRental/index'); ?>" <?php if($search['user_type'] == 0): ?>class="active"<?php endif; ?>>全部房源</a></h2>
                        <h2><a href="<?php echo getUrl('ShopsRental/index','user_type',$param,1); ?>" <?php if($search['user_type'] == 1): ?>class="active"<?php endif; ?>>个人房源</a></h2>
                        <h2><a href="<?php echo getUrl('ShopsRental/index','user_type',$param,2); ?>" <?php if($search['user_type'] == 2): ?>class="active"<?php endif; ?>>中介房源</a></h2>
                    </div>
                    <div class="tab sort-tab fr">
                        <ul>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,0); ?>" style="background:none;" <?php if($search['sort'] == 0): ?>class="active"<?php endif; ?>>默认排序</a></li>
                            <?php if($search['sort'] == 1): ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,2); ?>" class="active up">总价</a></li>
                            <?php elseif($search['sort'] == 2): ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,1); ?>" class="active down">总价</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,1); ?>">总价</a></li>
                            <?php endif; if($search['sort'] == 3): ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,4); ?>" class="active up">单价</a></li>
                            <?php elseif($search['sort'] == 4): ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,3); ?>" class="active down">单价</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,3); ?>">单价</a></li>
                            <?php endif; if($search['sort'] == 5): ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,6); ?>" class="active up">面积</a></li>
                            <?php elseif($search['sort'] == 6): ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,5); ?>" class="active down">面积</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('ShopsRental/index','sort',$param,5); ?>">面积</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                <div class="list_con sh_house_list">
                    <ul class="clearfix">
                        ...
                        <li>
                            <a href="<?php echo url('ShopsRental/detail',['id'=>$vo['id']]); ?>" target="_blank" title="<?php echo htmlentities($vo['title']); ?>">
								<span class="l_img fl">
								...
								<span class="r_con fr">
									...
									<p class="attr">
                                        <span class="info">装修：<?php echo getLinkMenuName(8,$vo['renovation']); ?></span>
                                        <span class="info">类型：<?php echo getLinkMenuName(18,$vo['type']); ?></span>
                                        <span class="info">面积：<?php echo htmlentities($vo['acreage']); ?><?php echo config('filter.acreage_unit'); ?></span>
                                        <?php if($vo['lease_type'] == 2): ?>转让费：<?php echo htmlentities($vo['transfer_fee']); ?>万<?php endif; ?>
                                    </p>
                                <p>
                                    <span class="tit" style="margin-right:5px;"><?php echo htmlentities($vo['estate_name']); ?></span>
                                    <span class="address"><?php echo htmlentities($vo['address']); ?></span>
                                </p>
                                    <p class="user-info">
                                        <span><i class="iconfont">&#xe605;</i><?php echo htmlentities($vo['contact_name']); if($vo['user_type'] == 1): ?>(个人)<?php else: ?>(经纪人)<?php endif; ?></span>
									...
									<span class="label_list clearfix">
                                        ...
                                        <i class="item item<?php echo htmlentities($n); ?>"><?php echo getLinkMenuName(20,$val); ?></i>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        <?php endif; ?>
									</span>
									<span class="price">
										<h5><strong><?php echo $vo['price']; ?></strong></h5>
										<p><?php echo htmlentities($vo['average_price']); ?></p>
									</span>
                                </span>
                            </a>
                        </li>
                                ...
                                <a href="<?php echo url('ShopsRental/detail',['id'=>$vo['id']]); ?>" target="_blank" title="<?php echo htmlentities($vo['title']); ?>">
                                    ...
                                    <div class="con">
                                        <div class="row clearfix">
                                            <p class="name fl"><?php echo htmlentities($vo['title']); ?></p>
