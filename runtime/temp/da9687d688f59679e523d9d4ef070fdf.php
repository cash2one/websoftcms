<?php /*a:2:{s:76:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/house/index.html";i:1544490344;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1536141234;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<div class="layui-form">
    <form name="layui-form" class="search-form" action="<?php echo url('House/index'); ?>" method="get" >
...
<form class="layui-form" action="">
    <div class="layui-form layui-border-box layui-table-view">
        <table id="tree-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('ajaxEdit'); ?>">
            ...
            <tr>
                ...
                <td data-field="title">
                    <a href="<?php echo url('House/detail@www',['id'=>$val['id']]); ?>" target="_blank"><?php echo htmlentities($val['title']); ?></a>
                        ...
                        <?php endif; if(!(empty($val['video']) || (($val['video'] instanceof \think\Collection || $val['video'] instanceof \think\Paginator ) && $val['video']->isEmpty()))): ?>
                        <i class="layui-icon layui-icon-video"></i>
                        <?php endif; if($val['rec_position'] == 1): ?>
                        <img src="/static/images/rec.png" alt="">
                        <?php endif; if(getSettingCache('site','red_packet') == 1 and $val['red_packet'] > 0): ?><br/><span style="color:green;">购房红包：<span data-tdtype="edit" data-field="red_packet" data-id="<?php echo htmlentities($val['id']); ?>" class="tdedit" style=""><?php echo htmlentities($val['red_packet']); ?></span>元</span><?php endif; ?>
                </td>
                <td>
                    <div class="layui-table-cell">
                ...
                <td>
                    <div class="layui-table-cell">
                        <?php echo htmlentities($val['price']); ?><?php echo htmlentities($val['unit']); ?>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
                        <?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($val['update_time'])? strtotime($val['update_time']) : $val['update_time'])); ?>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
    ...
    <div class="kaifazhe-fix-bottom layui-clear">
        <div class="kaifazhe-list-option layui-fl">
            ...
            <button type="button" lay-submit lay-filter="optionAll" data-msg="确定要删除所选项目么？" data-uri="<?php echo url('House/delete'); ?>" class="layui-btn layui-btn-danger layui-btn-sm">删除</button>
        </div>
