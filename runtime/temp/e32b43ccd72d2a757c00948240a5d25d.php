<?php /*a:2:{s:80:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/link_cate/index.html";i:1518078486;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
    ...
    <form class="layui-form" action="">
        <div class="layui-form layui-border-box layui-table-view">
            <div class="layui-table-header">
                <table class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('LinkCate/ajaxEdit'); ?>">
                    <colgroup>
                        <col width="5%">
                        <col width="5%">
                        <col width="20%">
                    ...
                    <tr data-index="<?php echo htmlentities($i); ?>" class="">
                        ...
                        <td>
                            <div class="layui-table-cell">
                                <span data-tdtype="edit" data-field="ordid" data-id="<?php echo htmlentities($val['id']); ?>" class="tdedit">
        ...
        <div class="kaifazhe-fix-bottom layui-clear">
            <div class="kaifazhe-list-option layui-fl">
                ...
                <button type="button" lay-submit lay-filter="optionAll" data-msg="确定要删除所选项目么？" data-uri="<?php echo url('LinkCate/delete'); ?>" class="layui-btn layui-btn-danger layui-btn-sm">删除</button>
            </div>
