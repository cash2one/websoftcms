<?php /*a:2:{s:75:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/house/edit.html";i:1544436874;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1536141234;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<form class="layui-form" id="info_form" data-uri="<?php echo url('Linkmenu/ajaxGetAttr'); ?>" data-cacheuri="<?php echo url('Linkmenu/ajaxGetMenuCache'); ?>" action="<?php echo url('House/editDo'); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				<div class="layui-form-item">
					...
					<?php $province_id = getProvinceIdByAreaId($info['city']); ?>
					<div class="layui-input-block">
						...
						<select class="J_city_select mr10" lay-filter="J_city_select" data-pid="0" data-uri="<?php echo url('City/ajaxGetchilds',['province_id'=>$province_id]); ?>" data-selected="<?php echo getCitySpidById($info['city']); ?>">
						</select>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" name="title" lay-verify="title" placeholder="楼盘名称" value="<?php echo htmlentities($info['title']); ?>" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-inline">
						...
						<div class="layui-input-inline" style="width:90px;">
							<input type="text" name="price"  lay-verify="price" size="10" placeholder="30000" value="<?php echo htmlentities($info->getData('price')); ?>" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-input-inline" style="width:80px;">
							<select name="unit" id="unit">
								...
								<option value="<?php echo htmlentities($key); ?>" <?php if($info->getData('unit') == $key): ?>selected<?php endif; ?>><?php echo htmlentities($vo); ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" lay-verify="address" id="address" name="address" placeholder="例：海秀路104号"  autocomplete="off" value="<?php echo htmlentities($info['address']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">售楼处地址 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="sale_address" placeholder="例：海秀路104号"  autocomplete="off" value="<?php echo htmlentities($info['sale_address']); ?>" >
						</div>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline" style="width:110px;">
							<input type="text" class="layui-input" name="opening_time" id="opening_time" placeholder="2016-10-20"  autocomplete="off" value="<?php if($info['opening_time'] > 0): ?><?php echo htmlentities(date('Y-m-d',!is_numeric($info['opening_time'])? strtotime($info['opening_time']) : $info['opening_time'])); ?><?php endif; ?>" >
						</div>
						<div class="layui-input-inline" style="width:190px;">
							<input type="text" class="layui-input" name="opening_time_memo" placeholder="1#,2#已开盘"  autocomplete="off" value="<?php echo htmlentities($info['opening_time_memo']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">交房时间 </label>
						<div class="layui-input-inline" style="width:110px;">
							<input type="text" class="layui-input" id="complate_time" name="complate_time" placeholder="2018-10-20"  autocomplete="off" value="<?php if($info['complate_time'] > 0): ?><?php echo htmlentities(date('Y-m-d',!is_numeric($info['complate_time'])? strtotime($info['complate_time']) : $info['complate_time'])); ?><?php endif; ?>" >
						</div>
						<div class="layui-input-inline" style="width:190px;">
							<input type="text" class="layui-input" name="complate_time_memo" placeholder="1#,2#已开盘"  autocomplete="off" value="<?php echo htmlentities($info['complate_time_memo']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline" style="width:200px;">
							<input type="text" class="layui-input" name="sale_phone[phone]" placeholder="0898-32266803"  autocomplete="off" value="<?php echo htmlentities($info['sale_phone']['phone']); ?>" >
						</div>
						...
						<div class="layui-input-inline" style="width:67px;">
							<input type="text" class="layui-input" name="sale_phone[extension]" placeholder="8888"  autocomplete="off" value="<?php echo htmlentities($info['sale_phone']['extension']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">预售证号 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="license_key" placeholder=" [2014]海房预字（0076）号"  autocomplete="off" value="<?php echo htmlentities($info['license_key']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="hidden" name="developer_id" id="developer_id" value="<?php echo htmlentities($info['developer_id']); ?>">
							<input type="text" class="layui-input" name="developer_name" id="developer_name" placeholder="富力地产"  autocomplete="off" value="<?php echo htmlentities($info['developer_name']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
				...
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="red_packet" lay-verify="required|number" placeholder="10000"  autocomplete="off" value="<?php echo htmlentities($info['red_packet']); ?>" >
						</div>
				...
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							<input type="checkbox" lay-skin="primary" lay-filter="discount" name="is_discount" value="1" <?php if($info['is_discount'] == 1): ?>checked<?php endif; ?>>
						</div>
					</div>
				</div>
				<div class="layui-form-item <?php if($info['is_discount'] == 0): ?>layui-hide<?php endif; ?>" id="discount">
					<div class="layui-block">
						<label class="layui-form-label">优惠内容 </label>
						<div class="layui-input-block">
							<textarea name="discount" id="" class="layui-textarea"><?php echo htmlentities($info['discount']); ?></textarea>
						</div>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					<div class="layui-block">
						<label class="layui-form-label">销售状态<a href="javascript:;" data-field="sale_status" data-type="radio" data-alert="销售状态" data-id="1" data-title="点击我可以管理销售状态" class="layui-icon layui-icon-set attr-manage"></a> </label>
						<div class="layui-input-block">
							<?php echo getLinkMenu(1,'sale_status','radio',$info['sale_status']); ?>
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							<?php echo getLinkMenu(2,'type_id','checkbox',$info['type_id']); ?>
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							<?php echo getLinkMenu(3,'tags_id','checkbox',$info['tags_id']); ?>
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							...
							<input type="checkbox" name="position[]" <?php if(in_array(($vo['id']), is_array($position_cate_id)?$position_cate_id:explode(',',$position_cate_id))): ?>checked<?php endif; ?> lay-skin="primary" value="<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>">
							<?php endforeach; endif; else: echo "" ;endif; ?>
							<input type="hidden" name="exists_pos" value="<?php echo implode(',',$position_cate_id); ?>">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="layui-upload">
							<input type="hidden" name="video" value="<?php echo htmlentities($info['video']); ?>" id="video">
							<div id="container">
							...
							<div id="ossfile"><?php echo htmlentities($info['video']); if(!(empty($info['video']) || (($info['video'] instanceof \think\Collection || $info['video'] instanceof \think\Paginator ) && $info['video']->isEmpty()))): ?><a href="javascript:;" data-file="<?php echo htmlentities($info['video']); ?>" id="delete_video" class="layui-btn layui-btn-xs layui-btn-danger">删除</a><?php endif; ?></div>
							<div id="console"></div>
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-inline" style="width:600px;">
						<input name="pano_url" id="pano_url" placeholder="在720yun.com创建全景相册,复制链接地址到输入框" value="<?php echo htmlentities($info['pano_url']); ?>" class="layui-input" />
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">楼盘介绍</label>
					<div class="layui-input-block">
						<script id="info" name="info" type="text/plain"><?php echo $data['info']; ?></script>
					</div>
				</div>
			</div>
			<div class="layui-tab-item">
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[building_type]" placeholder="板楼"  autocomplete="off" value="<?php echo htmlentities($data['attr']['building_type']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">产权年限 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[property_right]" placeholder="70年"  autocomplete="off" value="<?php echo htmlentities($data['attr']['property_right']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[area_covered]" placeholder="789009平米"  autocomplete="off" value="<?php echo htmlentities($data['attr']['area_covered']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">建筑面积 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[area_build]" placeholder="750098平米"  autocomplete="off" value="<?php echo htmlentities($data['attr']['area_build']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[volume_ratio]" placeholder="3.3"  autocomplete="off" value="<?php echo htmlentities($data['attr']['volume_ratio']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">绿化率 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[greening_rate]" placeholder="40%"  autocomplete="off" value="<?php echo htmlentities($data['attr']['greening_rate']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[plan_number]" placeholder="800户"  autocomplete="off" value="<?php echo htmlentities($data['attr']['plan_number']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">车位情况 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[parking_space]" placeholder="750个"  autocomplete="off" value="<?php echo htmlentities($data['attr']['parking_space']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[property_type]" placeholder="住宅"  autocomplete="off" value="<?php echo htmlentities($data['attr']['property_type']); ?>" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">物业公司 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[property_company]" placeholder="海航物业管理有限公司"  autocomplete="off" value="<?php echo htmlentities($data['attr']['property_company']); ?>" >
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="attr[property_fee]" placeholder="1.5元/平米/月"  autocomplete="off" value="<?php echo htmlentities($data['attr']['property_fee']); ?>" >
						</div>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							<input type="text" class="layui-input" name="seo[seo_title]" placeholder="seo标题"  autocomplete="off" value="<?php echo htmlentities($data['seo_title']); ?>" >
						</div>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							<input type="text" class="layui-input" name="seo[seo_keys]" placeholder="seo关键词"  autocomplete="off" value="<?php echo htmlentities($data['seo_keys']); ?>" >
						</div>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-block">
							<textarea name="seo[seo_desc]" class="layui-textarea" id="seo_desc"><?php echo htmlentities($data['seo_desc']); ?></textarea>
						</div>
					</div>
