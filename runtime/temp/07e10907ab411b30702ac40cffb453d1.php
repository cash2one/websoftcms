<?php /*a:2:{s:74:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/menu/edit.html";i:1517565684;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
    ...
    <form class="layui-form" id="info_form" action="<?php echo url('editDo'); ?>" method="post">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="title" id="title" value="<?php echo htmlentities($info['title']); ?>" placeholder="菜单名称" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="module_name" id="module_name" value="<?php echo htmlentities($info['module_name']); ?>" placeholder="控制器名称" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">方法名</label>
            <div class="layui-input-inline">
                <input type="text" name="action_name" id="action_name" value="<?php echo htmlentities($info['action_name']); ?>" class="layui-input" placeholder="方法名">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">附加参数</label>
            <div class="layui-input-inline">
                <input type="text" name="data" id="data" value="<?php echo htmlentities($info['data']); ?>" class="layui-input" placeholder="附加参数">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">字体图标</label>
            <div class="layui-input-inline">
                <input type="text" name="icon" id="icon" value="<?php echo htmlentities($info['icon']); ?>" class="layui-input" placeholder="字体图标">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">备注</label>
            <div class="layui-input-inline">
                <textarea name="remark" id="remark" class="layui-textarea"><?php echo htmlentities($info['remark']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">加到常用菜单</label>
            <div class="layui-input-inline">
                <input type="radio" name="often" class="radio_style" value="1" <?php if($info['often'] == 1): ?>checked="checked"<?php endif; ?> title="是">
                <input type="radio" name="often" class="radio_style" value="0" <?php if($info['often'] == 0): ?>checked="checked"<?php endif; ?> title="否">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">是否显示</label>
            <div class="layui-input-inline">
                <input type="radio" name="display" class="radio_style" value="1" <?php if($info['display'] == 1): ?>checked="checked"<?php endif; ?> title="是">
                <input type="radio" name="display" class="radio_style" value="0" <?php if($info['display'] == 0): ?>checked="checked"<?php endif; ?> title="否">
            </div>
        </div>
...
<script>
    $(function(){
        ...
        $("#title").formValidator({ onshow:'填写菜单名称', onfocus:'填写菜单名称', oncorrect:'正确'}).inputValidator({ min:1, onerror:'填写菜单名称'}).defaultPassed();
        $("#module_name").formValidator({ onshow:'填写控制器名', onfocus:'填写控制器名', oncorrect:'正确'}).inputValidator({ min:1, onerror:'填写控制器名'}).defaultPassed();
        $("#action_name").formValidator({ onshow:'填写方法名', onfocus:'填写方法名', oncorrect:'正确'}).inputValidator({ min:1, onerror:'填写方法名'}).defaultPassed();
