<?php /*a:2:{s:84:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/shops_rental/add.html";i:1540979842;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="content add_house">
    <form class="layui-form" id="info_form" action="<?php echo url('user.shops_rental/save'); ?>" method="post" enctype="multipart/form-data">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li style="float:right;"><a href="<?php echo url('user.shops_rental/index'); ?>" class="layui-btn layui-btn-sm" style="color:#fff;">商铺列表</a></li>
                <li><a href="<?php echo url('user.shops_rental/add'); ?>">发布出售</a></li>
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-inline" style="margin-left:10px;">
                                <input type="radio" name="price_type" value="1" checked="checked" title="<?php echo config('filter.rental_price_unit'); ?>"/>
                                <input type="radio" name="price_type" value="2" title="<?php echo config('filter.office_rental_unit'); ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="lease_type" lay-filter="lease_type" value="1" checked="checked" title="否" />
                                <input type="radio" name="lease_type" lay-filter="lease_type" value="2" title="是" />
                            </div>
                        </div>
                        <div class="layui-inline" id="transfer_fee" style="display:none;">
                            <label class="layui-form-label" style="width:auto;">转让费 </label>
                            <div class="layui-input-inline" style="width:50px;">
                                <input type="text" name="transfer_fee" class="layui-input" />
                            </div>
...
<script>
    ...
    layui.use(['form','element','upload','linkmenu'], function(){
        ...
        form.on('radio(lease_type)',function(data){
            var transefer = $("#transfer_fee");
            if(data.value == 1)
            {
                transefer.hide();
                transefer.find("input").val(0);
            }else{
                transefer.show();
            }
        });
