<?php /*a:4:{s:75:"/home/wwwroot/gxwebsoft/public_html/application/home/view/shops/detail.html";i:1541065654;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/peitao.html";i:1544237904;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page_tit">
    <div class="comWidth clearfix">
        ...
        <a href="<?php echo url('Shops/index'); ?>">商铺出售</a> &gt;
    ...
    <div class="comWidth">
        ...
        <div class="main_info">
            <div class="hd_box clearfix">
                ...
                <!-- on表示已收藏 -->
                <span class="collect_btn follow fr" data-id="<?php echo htmlentities($info['id']); ?>" data-model="shops" data-uri="<?php echo url('Api/follow'); ?>">关注房源</span>
            </div>
            <div class="con_box clearfix">
                ...
                <div class="rightArea">
                    <div class="t_box clearfix">
                        <div class="price fl">
                            <span><strong><?php echo $info['price']; ?></strong></span><span style="margin-left:10px;"><?php echo $info['average_price']; ?></span>
                        </div>
                        <div class="calc fr">
                    ...
                    <ul class="col_3_list clearfix">
                        ...
                        <li>
                            <p class="tit"><?php echo htmlentities($info['division']); ?></p>
                            <p class="txt">分割</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p class="tit"><?php echo getLinkMenuName(18,$info['type']); ?></p>
                            <p class="txt">类型</p>
                        </li>
                    </ul>
                    <div class="col_1 clearfix">
                        <span class="label">物业费 : </span><span class="desc"><?php echo htmlentities($info['property_fee']); ?>元/㎡·月</span>
                    </div>
                    <div class="col_1 clearfix">
                        <span class="label">楼盘 : </span><span class="desc"><?php echo htmlentities($info['estate_name']); ?></span>
                    </div>
                    <div class="col_1 clearfix">
                    ...
                    <div class="agent_info clearfix" style="margin-top:30px;">
                        ...
                        <div class="c_con fl">
                            <div class="row clearfix">
                                <?php if($info['user_type'] == 2): ?>
                                <p class="name fl"><a href="<?php echo url('Broker/shops',['id'=>$info['broker_id']]); ?>" title="<?php echo htmlentities($info['contact_name']); ?>写字楼" target="_blank"><?php echo htmlentities($info['contact_name']); ?>(经纪人)</a></p>
                                <?php else: ?>
                                <p class="name fl"><?php echo htmlentities($info['contact_name']); ?>(个人)</p>
                                <?php endif; ?>
                            </div>
                            <div class="row">
                                <p class="phone"><?php echo htmlentities($info['contact_phone']); ?></p>
                            </div>
                        </div>
                        <div class="r_con fr">
                            <a href="javascript:void(0);" class="btn appoint J_dialog" data-id="<?php echo htmlentities($info['id']); ?>" data-model="shops" data-type="1" data-uri="<?php echo url('Dialog/subscribe'); ?>">预约看房</a>
                        </div>
                    </div>
        ...
        <div class="con_wrap clearfix">
            <div class="leftArea cm_leftArea">
                ...
                <div class="house_general floor">
                    ...
                    <div class="bright_sopt clearfix" style="padding:0;">
                        <div class="houseList_wrap" style="margin:0 0 10px;">
                            <div class="sh_house_list list_con">
                                 <span class="label_list clearfix">
                                        <?php $tag = array_filter(explode(',',$info['tags'])); if(!(empty($tag) || (($tag instanceof \think\Collection || $tag instanceof \think\Paginator ) && $tag->isEmpty()))): if(is_array($tag) || $tag instanceof \think\Collection || $tag instanceof \think\Paginator): $n = 0; $__LIST__ = $tag;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($n % 2 );++$n;?>
                        ...
                        <div style="padding-bottom:10px;">
                            适合经营：
                            <?php $industry = array_filter(explode(',',$info['industry'])); if(!(empty($industry) || (($industry instanceof \think\Collection || $industry instanceof \think\Paginator ) && $industry->isEmpty()))): if(is_array($industry) || $industry instanceof \think\Collection || $industry instanceof \think\Paginator): $m = 0; $__LIST__ = $industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($m % 2 );++$m;if($m > 1): ?>，<?php endif; ?><i><?php echo getLinkMenuName(19,$val); ?></i>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php endif; ?>
                        </div>
                        <?php echo $info['info']; ?>
                ...
                <!-- 房源照片 E-->
                <?php if(!(empty($estate) || (($estate instanceof \think\Collection || $estate instanceof \think\Paginator ) && $estate->isEmpty()))): ?>
                <!-- 小区简介 S -->
                        ...
                        <div class="l_box fl">
                            ...
                            <ul class="pro_list clearfix">
                                ...
                                <li>
                                    ...
                                    <span class="txt"><?php echo htmlentities($estate['data']['property_type']); ?></span>
                                </li>
                                <li>
                                ...
                                <li style="width:360px;">
                                    ...
                                    <span class="txt"><?php echo htmlentities($estate['data']['property_company']); ?></span>
                                </li>
                            </ul>
                        ...
                        <ul class="clearfix">
                            ...
                            <li>
                                <a href="<?php echo url('Office/detail',['id'=>$vo['id']]); ?>" title="<?php echo htmlentities($vo['title']); ?>">
                                    ...
                                    <div class="con">
                                        <div class="row clearfix">
                                            <p class="type_area nowarp fl"><?php echo htmlentities($vo['title']); ?></p>
            ...
            <div class="similar_house floor">
                ...
                <div class="con_box">
                    <ul class="list clearfix">
                        <?php if(is_array($love) || $love instanceof \think\Collection || $love instanceof \think\Paginator): $i = 0; $__LIST__ = $love;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                        <li>
                            <a href="<?php echo url('Office/detail',['id'=>$data['id']]); ?>" title="<?php echo htmlentities($data['title']); ?>">
                                <div class="img">
                                ...
                                <div class="ft_con clearfix">
                                    <p class="type_area nowarp fl"><?php echo htmlentities($data['title']); ?></p>
