<?php /*a:2:{s:76:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/article/edit.html";i:1523962458;s:77:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/public/layout.html";i:1540436276;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<form class="layui-form" id="info_form" action="<?php echo url('Article/editDo'); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="layui-tab-item layui-show">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select class="J_cate_select mr10" lay-filter="J_cate_select" data-pid="0" data-uri="<?php echo url('ArticleCate/ajaxGetchilds'); ?>" data-selected="<?php echo htmlentities($selected_ids); ?>">
						</select>
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="title" lay-verify="title" value="<?php echo htmlentities($info['title']); ?>" placeholder="标题" value="" autocomplete="off" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block" style="width:880px;">
						<textarea placeholder="简介" name="description" class="layui-textarea"><?php echo htmlentities($info['description']); ?></textarea>
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
