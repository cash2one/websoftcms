<?php /*a:2:{s:77:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/developer/add.html";i:1562395259;s:77:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/public/layout.html";i:1540436276;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<form class="layui-form" id="info_form" action="<?php echo url('Developer/addDo'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="title" lay-verify="title" placeholder="客户名称" value="" autocomplete="off" class="layui-input">
                    </div>
                </div>
