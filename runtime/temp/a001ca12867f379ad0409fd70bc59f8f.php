<?php /*a:2:{s:78:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/rental/add.html";i:1540979842;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="content add_house">
    <form class="layui-form" id="info_form" action="<?php echo url('user.send/saveRental'); ?>" method="post" enctype="multipart/form-data">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li class="layui-this">发布出租房</li>
            </ul>
                ...
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                ...
                                <input type="text" name="estate_name" lay-verify="estate_id" id="estate_name"  class="layui-input" placeholder="锦锈花园">
                            </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-form-mid layui-word-aux layui-fl" style="margin-left:10px;"><?php echo config('filter.rental_price_unit'); ?></div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">朝向 </label>
                            <div class="layui-input-inline">
                                <?php echo getLinkMenu(4,'orientations'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="contacts[contact_name]" id="contact_name" value="<?php echo htmlentities($userInfo['nick_name']); ?>" placeholder="联系人" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">联系电话 </label>
                            <div class="layui-input-inline">
                                <input type="text" name="contacts[contact_phone]" id="contact_phone" placeholder="联系电话" value="<?php echo htmlentities($userInfo['mobile']); ?>" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <?php echo getLinkMenu(10,'rent_type'); ?>
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">支付方式 </label>
                            <div class="layui-input-inline">
                                <?php echo getLinkMenu(11,'pay_type'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-block">
                            ...
                            <div class="layui-input-block">
                                <?php echo getLinkMenu(12,'supporting','checkbox'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
...
//普通图片上传
        ...
        $('.btn-submit').on('click',function(){
            ...
            if(title.val().length == 0)
            {
                ...
                return false;
            }else if(!/\d+$/.test(acreage.val())){
                layer.msg('面积只能为数字',{icon:5});
                acreage.focus();
                return false;
            }else if(!/\d+$/.test(price.val())){
                layer.msg('价格只能为数字',{icon:5});
                price.focus();
                return false;
            }else{
                layer.load(1);
