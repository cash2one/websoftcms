<?php /*a:3:{s:82:"/home/wwwroot/gxwebsoft/public_html/application/home/view/office_rental/index.html";i:1541065970;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="searBar ">
    <div class="comWidth clearfix">
        <div class="sear_box fl">
            <form action="<?php echo url('OfficeRental/index'); ?>">
                <div class="ipt_area fl">
                    <input type="text" name="keyword" id="keyword" autocomplete="off" placeholder="输入小区名称或房源名称" data-uri="<?php echo url('Ajax/searchOfficeRental'); ?>" class="ipt">
        ...
        <a href="<?php echo url('Map/officeRental'); ?>" class="map_btn fr">地图找房</a>
    </div>
</div>
<!-- 搜索栏 E -->
<!-- 楼盘列表 S-->
    ...
    <div class="comWidth">
        ...
        <div class="seleBar">
            ...
            <div class="search-tab clearfix">
                <a href="<?php echo getUrl('OfficeRental/index','search_type',[],1); ?>" title="按区域查询" <?php if($search['search_type'] == 1): ?>class="active"<?php endif; ?>><i class="iconfont">&#xe609;</i>按区域查询</a>
                <a href="<?php echo getUrl('OfficeRental/index','search_type',[],2); ?>" title="按地铁查询" <?php if($search['search_type'] == 2): ?>class="active"<?php endif; ?>><i class="iconfont">&#xe61e;</i>按地铁查询</a>
            </div>
            <?php endif; ?>
            <div class="box">
                ...
                <div class="item clearfix">
                    <h3>地铁:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','metro',$param,0); ?>" <?php if($search['metro'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','metro',$param,$vo['id']); ?>" <?php if($search['metro'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                ...
                <div class="item clearfix">
                    <h3>站点:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','metro_station',$param,0); ?>" <?php if($search['metro_station'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','metro_station',$param,$vo['id']); ?>" <?php if($search['metro_station'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <?php endif; else: ?>
                <div class="item clearfix">
                    <h3>区域:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','area',$param,0); ?>" <?php if($search['area'] == $cityInfo['id']): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','area',$param,$vo['id']); ?>" <?php if($search['area'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                ...
                <div class="item clearfix">
                    <h3>商圈:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','area',$param,$param['area']); ?>" <?php if($search['rading'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','area',$param,$vo['id']); ?>" <?php if($search['rading'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <?php endif; ?>
                ...
                <div class="item clearfix">
                    <h3>租金:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','price',$param,0); ?>" <?php if($search['price'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        <?php $_result=getBussinessCondition("office_rental_price");if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo getUrl('OfficeRental/index','price',$param,$key); ?>" <?php if($search['price'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>面积:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','acreage',$param,0); ?>" <?php if($search['acreage'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','acreage',$param,$key); ?>" <?php if($search['acreage'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>类型:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','type',$param,0); ?>" <?php if($search['type'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','type',$param,$vo['id']); ?>" <?php if($search['type'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="item clearfix">
                    <h3>特色:</h3>
                    <ul class="list">
                        <li><a href="<?php echo getUrl('OfficeRental/index','tags',$param,0); ?>" <?php if($search['tags'] == 0): ?>class="active"<?php endif; ?>">全部</a></li>
                        ...
                        <li><a href="<?php echo getUrl('OfficeRental/index','tags',$param,$key); ?>" <?php if($search['tags'] == $key): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="main clearfix">
            ...
            <div class="houseList_wrap leftArea cm_leftArea">
                <div class="head clearfix">
                    <div class="tit fl">
                        <h2><a href="<?php echo url('OfficeRental/index'); ?>" <?php if($search['user_type'] == 0): ?>class="active"<?php endif; ?>>全部房源</a></h2>
                        <h2><a href="<?php echo getUrl('OfficeRental/index','user_type',$param,1); ?>" <?php if($search['user_type'] == 1): ?>class="active"<?php endif; ?>>个人房源</a></h2>
                        <h2><a href="<?php echo getUrl('OfficeRental/index','user_type',$param,2); ?>" <?php if($search['user_type'] == 2): ?>class="active"<?php endif; ?>>中介房源</a></h2>
                    </div>
                    <div class="tab sort-tab fr">
                        <ul>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,0); ?>" style="background:none;" <?php if($search['sort'] == 0): ?>class="active"<?php endif; ?>>默认排序</a></li>
                            <?php if($search['sort'] == 1): ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,2); ?>" class="active up">总价</a></li>
                            <?php elseif($search['sort'] == 2): ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,1); ?>" class="active down">总价</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,1); ?>">总价</a></li>
                            <?php endif; if($search['sort'] == 3): ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,4); ?>" class="active up">单价</a></li>
                            <?php elseif($search['sort'] == 4): ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,3); ?>" class="active down">单价</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,3); ?>">单价</a></li>
                            <?php endif; if($search['sort'] == 5): ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,6); ?>" class="active up">面积</a></li>
                            <?php elseif($search['sort'] == 6): ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,5); ?>" class="active down">面积</a></li>
                            <?php else: ?>
                            <li><a href="<?php echo getUrl('OfficeRental/index','sort',$param,5); ?>">面积</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                <div class="list_con sh_house_list">
                    <ul class="clearfix">
                        ...
                        <li>
                            <a href="<?php echo url('OfficeRental/detail',['id'=>$vo['id']]); ?>" target="_blank" title="<?php echo htmlentities($vo['title']); ?>">
								<span class="l_img fl">
								...
								<span class="r_con fr">
									...
									<p>
                                        ...
                                        <span class="l">|</span>
                                        <span class="info"><?php echo getLinkMenuName(17,$vo['grade']); ?></span>
                                    </p>
                                <p>
									...
									<span class="label_list clearfix">
                                        ...
                                        <i class="item item<?php echo htmlentities($n); ?>"><?php echo getLinkMenuName(16,$val); ?></i>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        <?php endif; ?>
									</span>
									<span class="price">
