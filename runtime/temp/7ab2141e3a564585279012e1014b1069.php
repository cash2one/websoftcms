<?php /*a:2:{s:73:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/house/add.html";i:1556066490;s:77:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/public/layout.html";i:1540436276;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
...
<form class="layui-form" id="info_form" action="<?php echo url('House/addDo'); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="layui-tab-item layui-show">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" lay-verify="address" id="address" name="address" placeholder="例：海秀路120号"  autocomplete="off" value="" >
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">售楼处地址 </label>
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="sale_address" placeholder="例：海秀路120号"  autocomplete="off" value="" >
						</div>
					</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="hidden" name="developer_id" id="developer_id" value="222">
				...
				<div class="layui-form-item">
					<div class="layui-block">
						...
						<div class="layui-input-inline">
							<input type="text" class="layui-input" name="red_packet" placeholder="10000"  autocomplete="off" value="" >
						</div>
				...
				<?php if(isset($storage['open']) && $storage['open'] == 1 && $storage['upload_type'] != 1): ?>
				<div class="layui-form-item">
...
<?php endif; ?>
<script src="/static/home/user/js/option.js"></script>
<script>
	//注意：选项卡 依赖 element 模块，否则无法进行功能性操作
	layui.use(['form','element','upload','linkmenu','laydate'], function(){
