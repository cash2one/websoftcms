<?php /*a:4:{s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/rental/detail.html";i:1541055730;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/peitao.html";i:1544237904;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page_tit">
    <div class="comWidth clearfix">
        ...
        <a href="<?php echo url('Rental/index'); ?>">租房</a> &gt;
    ...
    <div class="comWidth">
        ...
        <div class="main_info">
            <div class="hd_box clearfix">
                ...
                <span class="collect_btn follow fr" data-id="<?php echo htmlentities($info['id']); ?>" data-model="rental" data-uri="<?php echo url('Api/follow'); ?>">关注房源</span>
            </div>
            <div class="con_box clearfix">
                ...
                <div class="rightArea">
                    <div class="price clearfix">
                        <span><strong><?php echo $info['price']; ?></strong></span><span>（<?php echo getLinkMenuName(11,$info['pay_type']); ?>）</span>
                    </div>
                    <ul class="col_3_list clearfix">
                        <li>
                            <p class="tit"><?php echo getLinkMenuName(10,$info['rent_type']); ?></p>
                            <p class="txt">租赁方式</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p class="tit"><?php echo htmlentities($info['room']); ?>室<?php echo htmlentities($info['living_room']); ?>厅<?php echo htmlentities($info['toilet']); ?>卫</p>
                            <p class="txt">户型</p>
                        </li>
                        <li>
                    ...
                    <div class="agent_info clearfix" style="margin-top:30px;">
                        <img src="<?php echo getAvatar($info['broker_id'],90); ?>" width="68" height="68" alt="" class="per_img fl">
                        <div class="c_con fl">
                        ...
                        <div class="r_con fr">
                            ...
                            <a href="javascript:void(0);" class="btn appoint J_dialog" data-id="<?php echo htmlentities($info['id']); ?>" data-model="rental" data-type="1" data-uri="<?php echo url('Dialog/subscribe'); ?>">预约看房</a>
                        </div>
                    </div>
                    ...
                    <div class="con_box clearfix">
                        <div class="l_box fl">
                            ...
                            <div class="ft_desc clearfix">
                                <span><a href="<?php echo url('Second/index',['estate_id'=>$info['estate_id']]); ?>" title="<?php echo htmlentities($estate['title']); ?>在售二手房">在售二手房源（<?php echo htmlentities($info['second_total']); ?>套）</a></span>
                                <span><a href="<?php echo url('Rental/index',['estate_id'=>$info['estate_id']]); ?>" title="<?php echo htmlentities($estate['title']); ?>在租房源">在租房源（<?php echo htmlentities($info['total']); ?>套）</a></span>
                            </div>
                        </div>
                        <div class="r_box fr">
