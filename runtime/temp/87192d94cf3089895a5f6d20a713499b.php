<?php /*a:1:{s:75:"/home/wwwroot/gxwebsoft/public_html/application/agent/view/login/index.html";i:1562391510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<head>
    ...
    <link href="/static/sideshow/css/demo-1.css" rel="stylesheet" />
                ...
                <div class="kit-login-main">
                    <form action="<?php echo url('Login/loginDo'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            ...
                            <input type="text" name="username" lay-verify="required" autocomplete="off" value="" placeholder="手机号码登录." class="layui-input">
                        </div>
                        <div class="layui-form-item">
                            <label class="kit-login-icon">
                                <i class="layui-icon">&#xe642;</i>
                            </label>
                            <input type="password" name="password" lay-verify="required" autocomplete="off" value="" placeholder="这里输入密码." class="layui-input">
                        </div>
                        <div class="layui-form-item">
                            <label class="kit-login-icon">
                                <i class="layui-icon">&#xe60d;</i>
