<?php /*a:2:{s:84:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/position_cate/index.html";i:1535535752;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="model" id="model">
                            ...
                            <option value="<?php echo htmlentities($key); ?>" <?php if($key == $search['model']): ?>selected<?php endif; ?>><?php echo htmlentities($vo); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
    ...
    <div class="layui-form layui-border-box layui-table-view">
        <table id="tree-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('ajaxEdit'); ?>">
            ...
            <tr>
                ...
                <td>
                    <div class="layui-table-cell">
                        <?php if(isset($model[$val['model']])): ?>
                        <?php echo htmlentities($model[$val['model']]); ?>
                        <?php endif; ?>
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
                        <?php echo htmlentities($val['num']); ?>
                    </div>
                </td>
