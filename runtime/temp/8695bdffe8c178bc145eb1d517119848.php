<?php /*a:2:{s:79:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/shops/index.html";i:1541043404;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab">
    <a href="javascript:;" class="layui-btn layui-btn-sm">商铺出售</a>
    <a href="<?php echo url('user.shops_rental/index'); ?>" style="margin-left:20px;">商铺出租</a>
</div>
<div class="layui-form">
    <form name="layui-form" class="search-form" action="<?php echo url('user.shops/index'); ?>" method="get" >
...
<form class="layui-form" action="">
    <div class="layui-form layui-border-box layui-table-view">
        <table id="list-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-model="shops" data-uri="<?php echo url('Api/setTop'); ?>">
            <colgroup>
                <col width="5%">
                <col width="10%">
                <col width="40%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo url('edit',['id'=>$val['id']]); ?>" class="layui-btn layui-btn-xs">编辑</a><a href="javascript:;" data-msg="您确认要删除该条房源么？" data-uri="<?php echo url('user.shops/delete',['id'=>$val['id']]); ?>" class="J_confirm layui-btn layui-btn-xs layui-btn-danger">删除</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
    ...
    <div class="kaifazhe-fix-bottom layui-clear">
        <div class="kaifazhe-list-option layui-fl">
            ...
            <button type="button" lay-submit lay-filter="optionAll" data-msg="确定要删除所选项目么？" data-uri="<?php echo url('user.shops/delete'); ?>" class="layui-btn layui-btn-danger layui-btn-sm">删除</button>
        </div>
