<?php /*a:3:{s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/follow/rental.html";i:1541044188;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;s:78:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/follow/nav.html";i:1541044554;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form layui-border-box layui-table-view">
            <table id="tree-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <?php echo htmlentities($val['room']); ?>室<?php echo htmlentities($val['living_room']); ?>厅-<?php echo htmlentities($val['acreage']); ?>m²
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <a href="javascript:;" data-id="<?php echo htmlentities($val['id']); ?>" data-model="rental" data-uri="<?php echo url('Api/userCancelFollow'); ?>" class="cancel-follow layui-btn layui-btn-xs layui-btn-danger">取消关注</a>
                        </div>
                    </td>
                </tr>
