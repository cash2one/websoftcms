<?php /*a:3:{s:87:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/follow/shops_rental.html";i:1541044754;s:81:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/public/layout.html";i:1535441222;s:78:"/home/wwwroot/gxwebsoft/public_html/application/home/view/user/follow/nav.html";i:1541044554;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <tr>
                    <td>
                        <div class="layui-table-cell">
                            <a href="<?php echo url('ShopsRental/detail',['id'=>$val['id']]); ?>" target="_blank"><?php echo htmlentities($val['title']); ?></a>
                        </div>
                    </td>
                    <td>
                        <div class="layui-table-cell">
                    ...
                    <td>
                        <div class="layui-table-cell">
                            <a href="javascript:;" data-id="<?php echo htmlentities($val['id']); ?>" data-model="shops_rental" data-uri="<?php echo url('Api/userCancelFollow'); ?>" class="cancel-follow layui-btn layui-btn-xs layui-btn-danger">取消关注</a>
                        </div>
                    </td>
                </tr>
