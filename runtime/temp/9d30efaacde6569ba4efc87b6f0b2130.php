<?php /*a:2:{s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/comment/index.html";i:1532751874;s:78:"/home/wwwroot/gxwebsoft/public_html/application/manage/view/public/layout.html";i:1562673466;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8" />
    ...
    <div class="layui-form layui-border-box layui-table-view">
        <table id="tree-table" class="layui-table list-table" cellspacing="0" cellpadding="0" border="0" data-uri="<?php echo url('ajaxEdit'); ?>">
            ...
            <tr>
                ...
                <th>
                    <div class="layui-table-cell"><span>评论人</span></div>
                </th>
                <th>
            ...
            <tr>
                ...
                <td data-field="title" date-edit="true">
                    <div class="layui-table-cell">
                        ...
                        <img src="<?php echo getAvatar($val['user_id'],30); ?>" alt="" width="30">
                    </div>
                </td>
                <td>
                    <div class="layui-table-cell">
