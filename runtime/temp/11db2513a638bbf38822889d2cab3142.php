<?php /*a:3:{s:77:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/rental/index.html";i:1541067758;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/layout.html";i:1536722262;s:78:"/home/wwwroot/gxwebsoft/public_html/application/mobile/view/public/footer.html";i:1535332940;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="header-top">
    <header id="header" class="h-list-head">
        ...
        <a href="<?php echo url('Map/rental'); ?>" class="map-find-room">地图找房</a>
    </header>
    <!-- 筛选 S -->
                    ...
                    <article class="select_area">
                        ...
                        <section class="section" id="sort">
                            <ul class="clearfix">
                                ...
                                <li data-id="1">租金从低到高</li>
                                <li data-id="2">租金从高到低</li>
                                <li data-id="3">面积低到高</li>
                                <li data-id="4">面积从高到低</li>
                            </ul>
                        </section>
                        <section class="section" id="room">
                            ...
                            <ul class="clearfix">
                                ...
                                <li data-id="<?php echo htmlentities($key); ?>"><?php echo htmlentities($vo); ?></li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </section>
    ...
    <!-- 筛选 E -->
    <ul id="search-lists" data-uri="<?php echo url('Ajax/searchRental'); ?>"></ul>
</div>
...
<div class="main" style="background: #fff;padding-top:4.5rem;">
    ...
    <div style="padding-top: 0;">
        <div class="old-house house-show-box">
            <ul id="lists" data-uri="<?php echo url('Rental/getRentalLists'); ?>" data-total="<?php echo htmlentities($total_page); ?>">
                ...
                <li>
                    ...
                    <div class="intro-text">
                        ...
                        <p class="detail-text"><?php echo htmlentities($vo['room']); ?>室<?php echo htmlentities($vo['living_room']); ?>厅 <?php echo htmlentities($vo['acreage']); ?><?php echo config('filter.acreage_unit'); ?> <?php echo getLinkMenuName(8,$vo['renovation']); ?>&nbsp; <?php echo getTime($vo['update_time'],'mohu'); ?>更新</p>
                        <p class="good"><?php echo htmlentities($vo['address']); ?></p>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="intro-text">
                        <h4>
                            <a href="<?php echo url('Rental/detail',['id'=>$vo['id']]); ?>" title="<?php echo htmlentities($vo['title']); ?>">
                                <?php echo htmlentities($vo['estate_name']); ?>
                            </a>
                        </h4>
                        <p class="price"><span><?php echo getCityName($vo['city'],'-'); ?></span><span class="price-num"><em><?php echo $vo['price']; ?></em></span></p>
                        <p class="detail-text"><?php echo htmlentities($vo['room']); ?>室<?php echo htmlentities($vo['living_room']); ?>厅 <?php echo htmlentities($vo['acreage']); ?><?php echo config('filter.acreage_unit'); ?> <?php echo getLinkMenuName(8,$vo['renovation']); ?>&nbsp; <?php echo getTime($vo['update_time'],'mohu'); ?>更新</p>
...
<script type="text/html" id="template">
    ...
    <li>
        ...
        <div class="intro-text">
            ...
            <p class="detail-text">
                {{d[i].room}}室{{d[i].living_room}}厅 {{d[i].acreage}} {{d[i].renovation}}&nbsp; {{d[i].update_time}}更新
            </p>
            <p class="good">{{d[i].address}}</p>
        </div>
    </li>
    {{# } }}
...
<script type="text/javascript">
    ...
    function getParam()
    {
        var area = $('#area').attr('data-id'),price = $('#price').attr('data-id'),
                ...
                renovation = $('#renovation li.active').attr('data-id'),rental_type = $('#rental_type li.active').attr('data-id');
        return {
            area : area,
            price : price,
            type  : type,
