<?php /*a:4:{s:73:"/home/wwwroot/gxwebsoft/public_html/application/home/view/news/index.html";i:1537406944;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/layout.html";i:1541120186;s:73:"/home/wwwroot/gxwebsoft/public_html/application/home/view/news/right.html";i:1544584202;s:76:"/home/wwwroot/gxwebsoft/public_html/application/home/view/public/footer.html";i:1562384461;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="flash">
    <div class="con_wrap comWidth clearfix">
        <div class="sub_nav">
            <ul>
                <li><a href="<?php echo url('News/index'); ?>" <?php if($cate_id == 0): ?>class="active"<?php endif; ?>>全部</a></li>
                <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li><a href="<?php echo url('News/index',['cate'=>$vo['id']]); ?>" <?php if($cate_id == $vo['id']): ?>class="active"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="leftArea cm_leftArea">
            <ul class="flash_list clearfix">
                ...
                <li>
                    <a href="<?php echo url('News/detail',['id'=>$vo['id']]); ?>" target="_blank" title="<?php echo htmlentities($vo['title']); ?>">
                        <div class="l_img fl">
                            <img src="/static/images/nopic.jpg" data-original="<?php echo thumb($vo['img'],160,110); ?>" class="lazy" alt="<?php echo htmlentities($vo['title']); ?>">
                        </div>
                        <div class="r_con fr">
                            <h3><?php echo htmlentities($vo['title']); ?></h3>
                            <p class="desc"><?php echo htmlentities($vo['description']); ?></p>
                            <div class="f_box">
                                <span class="time"><?php echo getTime($vo['create_time']); ?></span>
                                <span class="view"><?php echo htmlentities($vo['hits']); ?></span>
                            </div>
                        </div>
                    </a>
                </li>
