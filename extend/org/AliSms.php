...
class AliSms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = self::getConfig('access_key_id');//"yourAccessKeyId"; // AccessKeyId

        $accessKeySecret = self::getConfig('access_key_secret');//"yourAccessKeySecret"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phoneNumbers, $templateParam = null, $templateCode = null,$outId = null, $smsUpExtendCode = null) {
        $signName = self::getConfig('sign');
        !$templateCode && $templateCode = self::getConfig('verify');
    ...
    {
        $config = getSettingCache('sms',$field);
        return $config;
    }
}
