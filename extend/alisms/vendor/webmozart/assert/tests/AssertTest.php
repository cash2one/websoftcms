...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getTests()
    {
        ...
        return array(
            ...
            array('isArray', array(new ArrayIterator([])), false),
            array('isArray', array(123), false),
            array('isArray', array(new stdClass()), false),
            array('isTraversable', array([]), true),
            array('isTraversable', array(array(1, 2, 3)), true),
            array('isTraversable', array(new ArrayIterator([])), true),
            ...
            array('isInstanceOf', array([], 'stdClass'), false),
            ...
            array('notInstanceOf', array([], 'stdClass'), true),
    ...
    public function getStringConversions()
    {
        return array(
            ...
            array('string', array([]), 'Expected a string. Got: array'),
            ...
            array('eq', array(new ArrayIterator([]), new stdClass()), 'Expected a value equal to stdClass. Got: ArrayIterator'),
